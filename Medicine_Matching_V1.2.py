...
synonyms_dict = {'':['dt', 'sr', 'cr', 'mr', 'er', 'dr', 'pr', 'xr', 'xl', 'xt', 'pr', 'dpi', 'mdi', 'md', 'ap', 'md'],
     ...
     '9s':['9x1','1[*]9','9tab'],
     '10s':['10x1','1[*]10','10tab'],
     '120s':['120x1', '1[*]120','120tab'],
     '150s':['150x1', '1[*]150','150tab'],
     '200s':['200x1', '1[*]200','200tab'],
     '15s':['15x1','1[*]15','15tab'],
     '20s':['20x1','1[*]20','20tab'],
     '25s':['25x1','1[*]25','25tab'],
     '30s':['30x1','1[*]30','30tab'],
...
df.to_csv('Combined_results.csv', index = False) # All Columns
...
print('Exact Match or Cosine = 1 -->', df_exact_match.shape[0])
print('Total SKUs -->', df_distributor.shape[0])

print('\n% of Exact Match --> ', df_exact_match.shape[0]*100/df_distributor.shape[0], '%', sep='')

df_exact_match[['item_code', 'brand_x', 'brand_y', 'manufacturer', 'id', 'mrp']].to_csv('Exact_match.csv', index = False)
df_others[['item_code', 'brand_x', 'brand_y', 'manufacturer', 'id', 'mrp']].to_csv('Cosine<1.csv', index = False)
