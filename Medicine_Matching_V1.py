...
os.chdir('/home/ubuntu/filestore/')

#####################################################################################################


#df_master = pd.read_csv('drug_master2.csv')
df_master = pd.read_csv('master_sku.csv') # Updated Master Data with sku for all
df_distributor = pd.read_csv('distributor_data.csv') # New Distributor data to be mapped

df_distributor.rename(columns = {'itemid':'item_code', 'ITENNAME':'brand', 'Item Code':'item_code', 'Description':'brand'}, inplace = True)
...
synonyms_dict = {'':['dt', 'sr', 'cr', 'mr', 'er', 'dr', 'pr', 'xr', 'xl', 'xt', 'pr', 'dpi', 'mdi', 'md', 'ap', 'md'],
     ...
     'drops':['drop', 'drps'],
     'expectorant':['expt'],
     'eye drops':['opthalmic solution','eye drop'],
     'eye':['eyes','opthalmic'],
     'eye/ear':['e/e'],
...
def find_capsule():
    ...
    print('Exact Match on full brand names - ', m, ' - ', (round)(m*100/df_cap.shape[0]),'%', sep = '')
    ...
    print('Exact Match on exp_sku_brand - ', m, ' - ', (round)(m*100/df_cap.shape[0]),'%', sep = '')
    ...
    print('Exact Match on exp_sku_brand2 - ', m, ' - ', (round)(m*100/df_cap.shape[0]),'%', sep = '')
    ...
    print('Exact Match on exp_sku_brand3 - ', m, ' - ', (round)(m*100/df_cap.shape[0]),'%', sep = '')
    ...
    print('Exact Match on exp_sku_brand4 - ', m, ' - ', (round)(m*100/df_cap.shape[0]),'%', sep = '')
    ...
    print('Only 1 Match with cosine>0.7 - ', m, ' - ', (round)(m*100/df_cap.shape[0]),'%', sep = '')
...
df_final2 = pd.merge(df_final2, df_distributor[['item_code', 'manufacturer']], on='item_code', how='left')
df_final3 = pd.merge(df_final3, df_distributor[['item_code', 'manufacturer']], on='item_code', how='left')
df_final4 = pd.merge(df_final4, df_distributor[['item_code', 'manufacturer']], on='item_code', how='left')
df_final5 = pd.merge(df_final5, df_distributor[['item_code', 'manufacturer']], on='item_code', how='left')
df_final6 = pd.merge(df_final6, df_distributor[['item_code', 'manufacturer']], on='item_code', how='left')
df_cap6 = pd.merge(df_cap6, df_distributor[['item_code', 'manufacturer']], on='item_code', how='left')
df_cap7 = pd.merge(df_cap7, df_distributor[['item_code', 'manufacturer']], on='item_code', how='left')
...
def find_tablet():
    ...
    df_final1 = df_final1.drop_duplicates(subset=['item_code', 'brand_x'], keep='last', ignore_index = True)
    m = df_final1[df_final1['brand_y'].notnull()].shape[0]
    print('Exact Match on full brand names - ', m, ' - ', (round)(m*100/df_tab.shape[0]),'%', sep = '')
    ...
    m = int(df_final2[df_final2['brand_y'].notnull()].item_code.nunique())
    print('Exact Match on exp_sku_brand - ', m, ' - ', (round)(m*100/df_tab.shape[0]),'%', sep = '')
    ...
    m = int(df_final3[df_final3['brand_y'].notnull()].item_code.nunique())
    print('Exact Match on exp_sku_brand2 - ', m, ' - ', (round)(m*100/df_tab.shape[0]),'%', sep = '')
    ...
    m = int(df_final4[df_final4['brand_y'].notnull()].item_code.nunique())
    print('Exact Match on exp_sku_brand3 - ', m, ' - ', (round)(m*100/df_tab.shape[0]),'%', sep = '')
    ...
    m = int(df_final5[df_final5['brand_y'].notnull()].item_code.nunique())
    print('Exact Match on exp_sku_brand4 - ', m, ' - ', (round)(m*100/df_tab.shape[0]),'%', sep = '')
    ...
    m = int(df_final6[df_final6['count']==1].item_code.nunique())
    print('Sku_brand = tbd - One Match - ', m, ' - ', (round)(m*100/df_tab.shape[0]),'%', sep = '')
...
df_final5 = pd.merge(df_final5, df_distributor[['item_code', 'manufacturer']], on='item_code', how='left')
df_final6 = pd.merge(df_final6, df_distributor[['item_code', 'manufacturer']], on='item_code', how='left')
df_tab6 = pd.merge(df_tab6, df_distributor[['item_code', 'manufacturer']], on='item_code', how='left')
df_tab7 = pd.merge(df_tab7, df_distributor[['item_code', 'manufacturer']], on='item_code', how='left')
...
df_final5 = pd.merge(df_final5, df_distributor[['item_code', 'manufacturer']], on='item_code', how='left')
df_final6 = pd.merge(df_final6, df_distributor[['item_code', 'manufacturer']], on='item_code', how='left')
df_syp7 = pd.merge(df_syp7, df_distributor[['item_code', 'manufacturer']], on='item_code', how='left')
